...
<div class="nk-block-head nk-block-head-sm">
  <div class="nk-block-between-md g-4">
    <div class="nk-block-head-content">
      <h2 class="nk-block-title fw-normal">{{ __('Welcome') }}, {{ auth()->user()->name }}</h2>
        ...
        <div class="nk-wg1">
          <div class="nk-wg1-block">
            ...
            <div class="nk-wg1-text">
              ...
              <p>{{ __('dashboard categories text') }}</p>
            </div>
          </div>
          <div class="nk-wg1-action">
            <a href="{{ route('panel.categories.index') }}" class="link"><span>{{ __('See all') }} ({{ $quantities['category'] }})</span> <em class="icon ni ni-chevron-right"></em></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="nk-wg1">
          <div class="nk-wg1-block">
            ...
            <div class="nk-wg1-text">
              ...
              <p>{{ __('dashboard project text') }}</p>
            </div>
          </div>
          <div class="nk-wg1-action">
            <a href="{{ route('panel.projects.index') }}" class="link"><span>{{ __('See all') }} ({{ $quantities['project'] }})</span> <em class="icon ni ni-chevron-right"></em></a>
          </div>
        </div>
      </div>
    </div>
